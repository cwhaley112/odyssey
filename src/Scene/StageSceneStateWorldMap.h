...
private:
    ...
    ShineTowerCommonKeeper* mShineTowerCommonKeeper;
    sead::Matrix34f mMatrix34;
    s32 mCurrentWorldId;
    s32 mMapChoice;
    s32 mNextLockedWorldId;
    s32 mUnlockWorldNum;
    s32 mCurrentWorldIndex;
    s32 unk_0x4;
    void* unk_0x44;
    s32 mNextLockedWorldNum;
    s32 mCurWorldNum;
    void* unk_0x8;
    WorldMapMovieUpdater* mWorldMapMovieUpdater;
    ViewRenderer* mViewRenderer;
    WorldMapCamera* mWorldMapCamera;
    DirLightParam* mDirLightParam;
    StageSceneStateCollectionList* mStageSceneStateCollectionList;
    bool mCanUnlockMoreWorlds;
    bool mGotAllMoonsInWorld;
